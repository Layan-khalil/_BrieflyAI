...
export default function Home() {
  ...
  useEffect(() => {
    fetch((process.env.NEXT_PUBLIC_BACKEND_URL || 'https://layan123-brieflyai-space.hf.space') + '/health');
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const backendUrl = typeof window !== 'undefined' && window.location.hostname === 'localhost'
        ? 'http://localhost:8002'
        : (process.env.NEXT_PUBLIC_BACKEND_URL || 'https://layan123-brieflyai-space.hf.space');
      ...
      {!loading && !hasResults && (
        <section className="relative z-10 min-h-[calc(100vh-70px)] flex flex-col items-center justify-center">
          <div className="flex flex-col items-center justify-center text-center px-8 py-16 w-full max-w-[680px] mx-auto">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3 w-full max-w-[600px]">
